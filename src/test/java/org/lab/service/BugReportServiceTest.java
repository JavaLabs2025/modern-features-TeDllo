...
class BugReportServiceTest extends TestBase {
    ...
    void testCreateBugReport() {
        ...
        BugReport bugReport = bugReportService.create(projectId, "Bug description");
    ...
    void testFixBugReport() {
        ...
        BugReport bugReport = bugReportService.create(projectId, "Bug");
        bugReportService.fix(bugReport.id());
        
        BugReport fixed = bugReportRepository.findById(bugReport.id()).orElseThrow();
    ...
    void testTestBugReport() {
        ...
        BugReport tested = bugReportRepository.findById(bugReport.id()).orElseThrow();
    ...
    void testCloseBugReport() {
        ...
        BugReport closed = bugReportRepository.findById(bugReport.id()).orElseThrow();
    ...
    void testListByUser() {
        ...
        BugReport bugReport1 = bugReportService.create(projectId, "Bug 1");
        BugReport bugReport2 = bugReportService.create(projectId, "Bug 2");
        
        List<BugReport> userBugs = bugReportService.listByUser(developerId);
